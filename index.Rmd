...
function generateLinks() {
  ...
  if (!act_id) {
    alert('Invalid URL. Please ensure it contains the act parameter.');
    return;
  }
  ...
  links.forEach(function(link, index) {
    var full_url = link.url + '&act=' + act_id;
    if (business_id) {
      full_url += '&business_id=' + business_id;
    }
    table_html += '<tr><td><a href="' + full_url + '" target="_blank">click here</a></td><td>' + link.name + '</td></tr>';
  });
  table_html += '</table>';
